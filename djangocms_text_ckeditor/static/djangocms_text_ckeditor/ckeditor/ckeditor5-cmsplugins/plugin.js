(function ($) {
    ...
    CKEDITOR.plugins.add('ckeditor5-cmsplugins', {

        // Register the icons. They must match command names.
        icons: 'ckeditor5-cmsplugins',
        ...
        init: function (editor) {
            ...
            // add the button
            this.editor.ui.add('ckeditor5-cmsplugins', CKEDITOR.UI_PANELBUTTON, {
                toolbar: 'cms,0',
                ...
                panel: {
                    ...
                    attributes: { 'role': 'ckeditor5-cmsplugins', 'aria-label': this.options.lang.aria }
                },
        ...
        setupContextMenu: function () {
            ...
            this.editor.addMenuItem('cmspluginsItem', {
                ...
                icon: CMS.CKEditor5.options.settings.static_url + '/ckeditor_plugins/ckeditor5-cmsplugins/icons/ckeditor5-cmsplugins.png',
